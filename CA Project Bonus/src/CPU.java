...
public class CPU {
    ...
    private final int coreId; // Core identifier
...
//    }
    ...
    public CPU(int coreId, ClockManager clockManager) {
...
//            System.out.println("\n\n");
    ...
    private void processPipeline() {
        ...
        clockManager.incrementAndReport(coreId);
        System.out.println("--------------------");
    }
    ...
    private void fetch() {
        if (!stages[PipelineStage.FETCH.ordinal()].isEmpty()) {
            ...
            System.out.println("Core " + coreId + " Fetching: " + instruction);
    ...
    private void decode() {
        if (!stages[PipelineStage.DECODE.ordinal()].isEmpty()) {
            ...
            System.out.println("Core " + coreId + " Decoding: " + instruction);
    ...
    private void memoryAccess() {
        if (!stages[PipelineStage.MEMORY.ordinal()].isEmpty()) {
            ...
            System.out.println("Core " + coreId + " Memory Access: " + instruction);
    ...
    private void writeBack() {
        if (!stages[PipelineStage.WRITE_BACK.ordinal()].isEmpty()) {
            ...
            System.out.println("Core " + coreId + " Write Back: " + instruction);
